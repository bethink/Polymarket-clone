...
function Navbar() {
  ...
  return (
    <>
      <nav
        aria-label="Top"
        className="mx-auto max-w-full px-4 sm:px-6 lg:px-8 w-full"
      >
        <div className="border-b border-gray-200">
          <div className="flex h-16 items-center">
            ...
            <div className="ml-4 flex lg:ml-0">
              <Link href="/" passHref>
                <h1 className="m-0 text-lg sm:text-2xl font-bold text-black dark:text-white">
            ...
            <div className="ml-auto flex items-center">
              {account ? (
                <div className="cursor-pointer flex items-center gap-2">
                  <div className="icon bg-gradient-to-r from-blue-500 from-50% to-rose-500 to-50% w-6 h-6 rounded-full"></div>
      ...
      {isSidebarOpen && (
        <div className="fixed inset-0 z-50 bg-cusBlack-300">
          <div className="w-64 h-screen bg-white text-black flex flex-col py-4 gap-4">
            <div className="logo-wrapper flex justify-between items-center px-4">
              <Link href="/" passHref>
                <h1 className="m-0 text-lg font-bold text-black dark:text-white">
                  {common_file.prediction_market.name}
                </h1>
              </Link>
...
const MobTabButton = ({
  ...
  return (
    <Link href={url} passHref>
      <div
        className={`flex items-center cursor-pointer p-2 w-full rounded-md ${
