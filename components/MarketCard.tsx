...
export const MarketCard: React.FC<MarketProps> = ({
  ...
  return (
    <div className="w-full h-full overflow-hidden sm:my-1 sm:px-1 sm:w-1/3 md:my-2 md:px-2 md:w-1/3 lg:w-1/3 xl:w-1/3 my-2">
      <Link href={`/market/${id}`} passHref>
        <div className="flex h-full flex-col border border-gray-300 rounded-lg p-3 hover:border-blue-700 cursor-pointer">
